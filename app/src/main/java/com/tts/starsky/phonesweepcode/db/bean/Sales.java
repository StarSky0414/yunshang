...
public class Sales {
    ...
    @Generated(hash = 355832542)
    public Sales(String salesId, String createTime, double profit, double originalPrice,
            double realityPrice, Long userFatherId, Long userSonId) {
