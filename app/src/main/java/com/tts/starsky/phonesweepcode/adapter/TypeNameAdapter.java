...
public class TypeNameAdapter extends BaseAdapter {
    ...
    private List<GoodsTypeInfo> typeGeneralizeInfoList;
    ...
    public TypeNameAdapter(Context context, List<GoodsTypeInfo> typeGeneralizeInfoList, RecyclerView rv_type_content) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_type_name.setText(typeGeneralizeInfoList.get(position).getType_concrete_name());
        return convertView;
    }
