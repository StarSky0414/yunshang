...
public class TraceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TraceOnClickListener traceOnClickListener;

    public TraceListAdapter(Context context, List<Trace> traceList) {
        inflater = LayoutInflater.from(context);
        traceOnClickListener = new TraceOnClickListener(context);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemHolder.tvAcceptTime.setTag(position);
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tvAcceptTime.setOnClickListener(traceOnClickListener);
